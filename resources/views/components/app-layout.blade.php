                        ...
                        <div class="col-lg-6 col-md-6 d-none d-md-block px-0">
                            ...
                            <div class="gmap h-100">
                                <iframe width="100%" height="50%"
                                    src="https://maps.google.com/maps?q=-4.001825,%20-79.204704&t=&z=20&ie=UTF8&iwloc=&output=embed"
                                    frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
                                    style="filter: grayscale(0.5) contrast(1) opacity(0.8)"></iframe>
                            </div>
                        </div>
                                ...
                                <form class="row mb-0" id="template-contactform" name="template-contactform"
                                    ...
                                    <div class="col-12 center mb-4">
                                        ...
                                        <small style="display: block; font-size: 13px; margin-top: 15px;">We'll do our
                                            best to get back to you within 6-8 working hours.</small>
                                    </div>
